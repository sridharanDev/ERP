...
@Component({
  selector: 'app-staff-worklog',
  templateUrl: './staff-worklog.component.html',
  styleUrls: ['./staff-worklog.component.css']
})
export class StaffWorklogComponent implements OnInit
{
  ...
  GetAllWorklogs()
  {
    ...
    this.worklogService.GetWorklogs(query).subscribe((res:any)=>{
  ...
  OnAddSubmit()
  {
    ...
    this.isLoading = true;
    this.worklogService.CreateWorklog(formData).subscribe((res:any)=>{
      this.modalService.dismissAll();
      this.GetAllWorklogs();
      this.toastr.success("Worklog added successfully. ", 'Add worklog.',{timeOut: 3000,closeButton: true,progressBar: true,},);
      this.isLoading = false;
    },(error)=>{
      this.toastr.error(error.error, 'Something went wrong.',{timeOut: 3000,closeButton: true,progressBar: true,},);
      this.isLoading = false;
